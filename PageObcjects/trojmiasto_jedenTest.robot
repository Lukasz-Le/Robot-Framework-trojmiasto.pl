*** Settings ***
Resource    ./KeyWordDefinitionsFiles/ArticlesTitles.robot
Resource    ./KeyWordDefinitionsFiles/CommonFunctionality.robot
Resource    ./KeyWordDefinitionsFiles/MainPage.robot
Resource    ./KeyWordDefinitionsFiles/NewsPage.robot
